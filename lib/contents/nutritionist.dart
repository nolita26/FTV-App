...
//  RecommendedPage({Key key}) : super(key: key);
  ...
  Widget _header(BuildContext context) {
    ...
    return ClipRRect(
        ...
        child: Container(
            height: 120,
            width: width,
            decoration: BoxDecoration(color: LightColor.yellow),
            child: Stack(
              fit: StackFit.expand,
  ...
  Widget _card(
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: <BoxShadow>[
              BoxShadow(offset: Offset(0, 5), blurRadius: 10, color: Color(0x12000000)),
            ]),
        child: ClipRRect(
          borderRadius: BorderRadius.all(Radius.circular(20)),
          child: backWidget,
    ...
    return Stack(
        children: <Widget>[
          Positioned(
              top: top,
              left: left,
              child: CircleAvatar(radius: 100, backgroundColor: LightColor.darkpurple)),
          ...
          Positioned(
              top: 110,
              right: -50,
              child: CircleAvatar(radius: 60, backgroundColor: LightColor.darkpurple,
                child: CircleAvatar(radius: 40, backgroundColor: LightColor.lightpurple),
              )),
        ]);
  }
        ...
        children: <Widget>[
          Positioned(
              ...
              child: CircleAvatar(
                  ...
                  child: CircleAvatar(radius: 30, backgroundColor: LightColor.darkYellow))),
          Positioned(
              bottom: -35,
              right: -40,
              child:
    ...
    return Stack(
        children: <Widget>[
          Positioned(
              bottom: -65,
              left: -35,
              child: CircleAvatar(radius: 70, backgroundColor: LightColor.lightpurple)),
          Positioned(
              bottom: -30,
              right: -25,
              child: ClipRect(
                  clipper: QuadClipper(),
                  child: CircleAvatar(backgroundColor: LightColor.darkpurple, radius: 40))),
          _smallContainer(LightColor.lightpurple, 35, 70),
        ]);
  }
    ...
    return Stack(
        children: <Widget>[
          Positioned(
              top: -65,
              left: -65,
              child: CircleAvatar(radius: 70, backgroundColor: LightColor.lightYellow,
                  child: CircleAvatar(radius: 30, backgroundColor: LightColor.darkYellow))),
          Positioned(
              bottom: -35,
              right: -40,
  ...
  Positioned _smallContainer(Color primaryColor, double top, double left,
    ...
    return Positioned(
        top: top,
        left: left,
        child: CircleAvatar(radius: radius, backgroundColor: primaryColor.withAlpha(255)));
  }
